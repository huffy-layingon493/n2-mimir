// schema.rs — SQL schema definition (architecture.md section 8-2)
// All table/index creation statements for Mímir database

/// Complete SQL schema for initialization
...
-- embeddings: optional vector storage for semantic search (Tier 2)
